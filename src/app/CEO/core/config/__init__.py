...
from app.CFO.config.agent import CFOConfigAgent
from app.CIO.config.agent import CIOInfrastructureConfigAgent
from app.CIO.services.config_platform import ConfigManager, get_config_manager
from app.COO.config.agent import COOConfigAgent
from app.CSO.config.agent import CSOConfigAgent


DOMAIN_SPECS: dict[str, tuple[str, str]] = {
    "ceo_application": ("application", "app.CEO.config.schema.ApplicationGovernanceConfig"),
    "ceo_leaders": ("leaders", "app.CEO.config.schema.ControlPlaneLeadersConfig"),
    "ceo_permissions": ("permissions", "app.CEO.config.schema.PermissionMatrixConfig"),
    "ceo_departments": ("departments", "app.CEO.config.schema.DepartmentsGovernanceConfig"),
    "ceo_workflow": ("workflow", "app.CEO.config.schema.WorkflowGovernanceConfig"),
    "cio_database": ("database", "app.CIO.config.schema.DatabaseConfig"),
    "cio_redis": ("redis", "app.CIO.config.schema.RedisConfig"),
    "cio_ai_providers": ("ai_providers", "app.CIO.config.schema.AIProvidersConfig"),
    "cio_storage": ("storage", "app.CIO.config.schema.StorageConfig"),
    "cfo_finance": ("finance", "app.CFO.config.schema.FinanceConfig"),
    "coo_production": ("production", "app.COO.config.schema.ProductionConfig"),
    "cso_hotspot": ("hotspot", "app.CSO.config.schema.HotspotConfig"),
}
