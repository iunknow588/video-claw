...
DEFAULT_PUBLIC_AGENT_ROSTER: list[dict[str, Any]] = [
    {
        "agent_name": "CMOAgent",
        "entrypoint": "departments.CMO.agent.CMOAgent",
    ...
    {
        "agent_name": "CFOAgent",
        "entrypoint": "departments.CFO.agent.CFOAgent",
        "domain": "finance_gate",
    ...
    {
        "agent_name": "CIOAgent",
        "entrypoint": "departments.CIO.agent.CIOAgent",
    ...
    },
    {
        ...
        "entrypoint": "departments.CSO.agent.ResearchAgent",
        "domain": "CSO",
    ...
    },
    {
        ...
        "entrypoint": "departments.CCO.agent.AnalysisAgent",
        "domain": "CCO",
        "scope": "production_support",
    ...
    },
    {
        ...
        "entrypoint": "departments.COO.agent.ProductionAgent",
        "domain": "COO",
    ...
    {
        "agent_name": "CAOAgent",
        "entrypoint": "departments.CAO.agent.CAOAgent",
