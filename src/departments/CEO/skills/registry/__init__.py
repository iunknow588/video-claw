...
from departments.CEO.skills.runtime import SkillDescriptor, build_descriptor


DEPARTMENT_SKILL_MODULES = (
    "departments.CEO.skills",
    "departments.CFO.skills",
    "departments.CIO.skills",
    "departments.CHO.skills",
    "departments.CMO.skills",
    "departments.CSO.skills",
    "departments.CCO.skills",
    "departments.CTO.skills",
    "departments.COO.skills",
    "departments.CQO.skills",
    "departments.CAO.skills",
)
